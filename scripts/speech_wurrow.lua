...
return {
	...
	DESCRIBE =
	{
		...
		WORMLIGHT = "I'll grow big soon!",
		WORMLIGHT_LESSER = "Looks just like mine.",
		WORM =
		{
		    PLANT = "Someone's already staying there.",
		    DIRT = "Aww this dirts already used.",
		    WORM = "Hi friend!",
		},
        WORMLIGHT_PLANT = "They wouldn't mind, would they?",
		MOLE =
		{
