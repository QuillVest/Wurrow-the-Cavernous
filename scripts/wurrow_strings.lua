...
STRINGS.NAMES.TOOTHKIT_MOONGLASS = "Moon Glass Floss"
...
STRINGS.RECIPE_DESC.TOOTHKIT_STINGER = "Don't drop it."
STRINGS.RECIPE_DESC.TOOTHKIT_CALCITE = "Smells like a dentist."
STRINGS.RECIPE_DESC.TOOTHKIT_BONE = "Finely crafted from an amalgam of ivory."
STRINGS.RECIPE_DESC.TOOTHKIT_THULECITE = "Smells old and dangerous."
